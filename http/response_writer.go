...
func (r ResponseWriter) WriteJSON(obj interface{}) (int, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "could not marshal entity to JSON data")
	}
	...
	if err != nil {
		return 0, errors.Wrap(err, "could not write JSON data to response")
	}
...
func (r ResponseWriter) WriteXML(obj interface{}) (int, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "could not marshal entity to XML data")
	}
	...
	if err != nil {
		return 0, errors.Wrap(err, "could not write XML data to response")
	}
...
func (r ResponseWriter) WriteString(str string) (int, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "could not write string data to response")
	}
